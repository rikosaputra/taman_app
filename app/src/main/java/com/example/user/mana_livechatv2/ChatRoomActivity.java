...
import com.example.user.mana_livechatv2.adapter.ChatRoomThreadAdapter;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog.setMessage("Mengambil pesan...");
...
//        Log.d("de", intent.getStringExtra("name"));
        ...
        if (chatRoomId == null) {
            Toast.makeText(getApplicationContext(), "Percakapan tidak ditemukan", Toast.LENGTH_SHORT).show();
            finish();
        }

        db_chatRoom.updateChatRoom("0", "", chatRoomId);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        MyApplication.getInstance().getPrefManager().storeCurrentChatRoom(chatRoomId);
...
//        Log.d("debug_push", "handlePushNotification();->Chat Room Activity");
        ...
        if (chatRoomId != null && MyApplication.getInstance().getPrefManager().getCurrentChatRoom().equals(chatRoomId)) {
            if (message != null) {
    ...
    private void sendMessage() {
        ...
        if (TextUtils.isEmpty(message)) {
            Toast.makeText(getApplicationContext(), "Masukkan pesan", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error") == false) {
                        ...
                        User user = new User(userId, userName, null, fullName, null);
...
//        Log.d(TAG, "showDialog()->ChatRoomActivity");
        if (!pDialog.isShowing())
            pDialog.show();
    }

    private void hideDialog() {
//        Log.d(TAG, "hideDialog()->ChatRoomActivity");
