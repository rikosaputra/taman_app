...
/**
 * Created by ThinkPad T440s VPro on 26/07/2016.
 */
public class fetchDataLahanIdNew {
    ...
    public static class getPositions extends AsyncTask<String, Void, String > {
        ...
        protected String doInBackground(String... params) {
            ...
            String readStream = "";
            try {
                URL url = new URL("http://202.56.170.37/mobile-agro/varietas/varietas_idkab.php");
        ...
        protected void onPostExecute(String unused) {
            setMarkers();
            if (lokasi.equals("")) {
                lokasi = "Data tidak dapat ditemukan";
            }
            tv1.setText(lokasi);
            delegate.fetchLahanIdFinish();
        }
