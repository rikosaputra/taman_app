 ...
 */
public class fetchDataLahanNew {
    ...
    public static class getPositions extends AsyncTask<String, Void, String > {
        ...
        protected String doInBackground(String... params) {
            ...
            currLat = Double.parseDouble(params[0]);
            currLng = Double.parseDouble(params[1]);
            String readStream = "";
            try {
                ...
                try {
                    ...
                    if (readStream != null) {
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            BenihActivity.BenihKabId = id;
                            PupukActivity.PupukKabId = id;
                            AlsinActivity.AlsinKabId = id;
        ...
        public AsyncFetchData delegate = null;
        public interface AsyncFetchData {
            void fetchLahanFinish();
        }
        public getPositions(AsyncFetchData delegate) { this.delegate = delegate; }
        @Override
        ...
        private void setMarkers() {
            if (lats.size()>0) {
                ...
                for (int i = 0; i < latArray.length; i++) {
                    latLng = new LatLng(currLat + latAdd[i], currLng + lngAdd[i]);
