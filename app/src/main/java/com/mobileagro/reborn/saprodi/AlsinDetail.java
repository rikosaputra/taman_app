...
public class AlsinDetail extends AppCompatActivity {
    String kodeKom;
    int alsinId;
    TextView NamaTv, DeskTv, AlamatTv, KontakTv, TelpTv, EmailTv;
    TextView NamaTitle;
    String AlsinDetailURL = "http://202.56.170.37/mobile-agro/new/alsin_detail.php";
    TableLayout tbl;
    TableRow tr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alsin_detail);

        Bundle b = getIntent().getExtras();
        kodeKom = b.getString("KODE_KOM");
        alsinId = b.getInt("ALSIN_ID");
    ...
    private void fetchAlsinDetail() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AlsinDetailURL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    System.out.println("Alsin Detail Response: " + response);
                    ...
                    if (response != null) {
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            String NamaAlsin = jsonObj.getString("nama_alsin");
                            String StatusAlsin = jsonObj.getString("status");
                            ...
                            tva.setText("");
                            tvb.setText(NamaAlsin);
                            tvc.setText(StatusAlsin);
                            tva.setTextSize(14);
                            tvb.setTextSize(14);
                            tvc.setTextSize(14);
            ...
            protected Map<String, String> getParams() {
                ...
                System.out.println("Alsin ID: " + alsinId);
                System.out.println("Kode-KOM: " + kodeKom);
                params.put("kode_kom", kodeKom);
                params.put("id_alsin", String.valueOf(alsinId));
                return params;
            }
        };
