...
public class PupukActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, fetchDataLahanNew.getPositions.AsyncFetchData, GoogleApiClient.OnConnectionFailedListener, LocationListener, fetchKabupaten.getKabs.AsyncResponse {
    ...
    String PupukURL = "http://202.56.170.37/mobile-agro/new/pupuk.php";
    String kodeKom;
    private HashMap<Marker, Integer> mHashMap = new HashMap<Marker, Integer>();
    public static String PupukKabId;
    ...
    private void fethDataPupuk() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                PupukURL, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                System.out.println("Kab-ID: " + PupukKabId);
                System.out.println("Kode-KOM: " + kodeKom);
                params.put("kab_id", PupukKabId);
    ...
    public void showCurrLocPupuk(View v) {
    ...
    public void onConnected(Bundle bundle) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Intent intent = new Intent(getBaseContext(), PupukDetail.class);
                intent.putExtra("KODE_KOM", kodeKom);
                intent.putExtra("PUPUK_ID", id);
    ...
    public void searchLocPupuk(View v) {
        map.clear();
        PupukKabId = selectedKabId;
        getKabPos(PupukKabId);
        fethDataPupuk();
    }
