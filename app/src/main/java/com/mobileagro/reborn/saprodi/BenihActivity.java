...
public class BenihActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, fetchDataLahanNew.getPositions.AsyncFetchData, GoogleApiClient.OnConnectionFailedListener, LocationListener, fetchKabupaten.getKabs.AsyncResponse {
    ...
    String BenihURL = "http://202.56.170.37/mobile-agro/new/benih.php";
    String kodeKom;
    private HashMap<Marker, Integer> mHashMap = new HashMap<Marker, Integer>();
    public static String BenihKabId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_benih);
    ...
    private void fetchDataBenih() {
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    BenihURL, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                System.out.println("Kab-ID" + BenihKabId);
                System.out.println("Kode-KOM" + kodeKom);
                params.put("kab_id", BenihKabId);
    ...
    public void showCurrLocBenih(View v) {
    ...
    public void onConnected(Bundle bundle) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Intent intent = new Intent(getBaseContext(), BenihDetail.class);
                intent.putExtra("KODE_KOM", kodeKom);
                intent.putExtra("BENIH_ID", id);
    ...
    public void searchLocBenih(View v) {
        map.clear();
        BenihKabId = selectedKabId;
        getKabPos(BenihKabId);
        fetchDataBenih();
    }
