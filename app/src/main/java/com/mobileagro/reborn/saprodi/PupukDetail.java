...
public class PupukDetail extends AppCompatActivity {
    String kodeKom;
    int pupukId;
    TextView NamaTv, DeskTv, AlamatTv, KontakTv, TelpTv, EmailTv;
    TextView NamaTitle;
    String PupukDetailURL = "http://202.56.170.37/mobile-agro/new/pupuk_detail.php";
    TableLayout tbl;
    TableRow tr;
    ...
    private void fetchPupukDetail() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                PupukDetailURL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    System.out.println("Pupuk Detail Response: " + response);
                    ...
                    if (response != null) {
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            String NamaPupuk = jsonObj.getString("nama_pupuk");
                            String StatusPupuk = jsonObj.getString("status");
                            ...
                            tva.setText("");
                            tvb.setText(NamaPupuk);
                            tvc.setText(StatusPupuk);
                            tva.setTextSize(14);
                            tvb.setTextSize(14);
                            tvc.setTextSize(14);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("id_pupuk", String.valueOf(pupukId));
                return params;
            }
        };
